...
INSERT INTO [dbo].[Issue] ([Id], [AssigneeId], [IssueReporterId], [ReportedDate], [Content]) VALUES (4, 1, 3, N'2020-09-06 15:09:05', N'The Web API fails for large amount of data > 800MB')
INSERT INTO [dbo].[Issue] ([Id], [AssigneeId], [IssueReporterId], [ReportedDate], [Content]) VALUES (5, 1, 3, N'2020-09-07 15:15:33', N'Page load takes more than 3 mins for dashboard')
